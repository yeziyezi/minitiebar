...
class PostSearch extends Post
{
    ...
    {
        return [
            [['id', 'title', 'content', 'publish_time', 'last_reply_time', 'bar_id'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'reply_number' => $this->reply_number,
            'publish_user' => $this->publish_user,
            'reply_status' => $this->reply_status,
            'stick_status' => $this->stick_status,
        ]);

        $query->andFilterWhere(['like', 'id', $this->id])
            ->andFilterWhere(['like', 'title', $this->title])
            ->andFilterWhere(['like', 'content', $this->content])
            ->andFilterWhere(['like', 'bar_id', $this->bar_id]);
